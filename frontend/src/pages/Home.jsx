...
const Home = () => {
  ...
  return (
    <div className="min-h-screen">
      <section className="relative bg-gradient-to-br from-primary-500 via-primary-600 to-secondary-600 text-white py-20 md:py-32 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center">
            <h1 className="text-4xl md:text-6xl font-bold mb-6 animate-fade-in">
              ...
              <br />
              <span className="text-white bg-secondary-700 px-4 py-2 rounded-lg inline-block mt-2">At Unbeatable Prices</span>
            </h1>
            <p className="text-xl md:text-2xl mb-8 text-white/90">
              Netflix, Prime Video, Disney+, Spotify & More
            </p>
            <div className="flex justify-center">
              <Link to="/shop" className="bg-white text-primary-600 hover:bg-primary-50 font-bold py-4 px-8 rounded-lg transition-all transform hover:scale-105 hover:shadow-2xl inline-flex items-center justify-center">
      ...
      <section className="py-16 bg-gray-50 dark:bg-gray-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-4 text-secondary-700 dark:text-white">
